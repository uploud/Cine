...
export function OfferSection() {
  return (
    <section id="oferta" className="bg-white py-16 sm:py-20 px-4 sm:px-6 flex flex-col items-center">
      ...
      <div className="w-full max-w-[1100px] flex justify-center items-stretch mt-4">

        {/* Offer: Combo Completo */}
        <div className="w-full max-w-lg bg-white rounded-2xl shadow-[0_10px_50px_rgba(76,141,247,0.15)] border-2 border-[#4C8DF7] p-6 sm:p-8 relative overflow-hidden flex flex-col z-10">
